...
\title [CHAMPS]{\large IPW3 : NACA0012 Code-to-Code Comparisons} 
...
\input{SLIDES/CASE_CONDITIONS}
\input{SLIDES/AERODYNAMIC_CONVERGENCE}
\input{SLIDES/IMPINGEMENT_CONVERGENCE}
\input{SLIDES/HTC_CONVERGENCE}
\input{SLIDES/ICE_ACCRETION_CONVERGENCE}
\input{SLIDES/SURF_TEMP_FF}
\input{SLIDES/OVERALL_ASSESSMENT}
