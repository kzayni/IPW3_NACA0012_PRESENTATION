...
\begin{itemize}
    ...
    \item Relative to L1, the largest coarse-grid deviations are approximately $4\%$.
\end{itemize}
\end{block}
...
{\centering
\includegraphics[width=0.7\textwidth]{FIGURES/AERODYNAMIC/tc_naca0012_ae3932_cmy_vs_n_all_roughness.png}
\par}
...
{\centering
\includegraphics[width=.8\textwidth]{FIGURES/AERODYNAMIC/tc_naca0012_ae3932_L1_cp_vs_s_slice_0p9144_all_roughness.png}
\par}
