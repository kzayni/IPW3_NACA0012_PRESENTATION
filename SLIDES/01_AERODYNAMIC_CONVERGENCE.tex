...
\section[Aerodynamics]{\textbf{Aerodynamics}}
...
\begin{itemize}
    ...
    \item $C_D$ exhibits the greatest sensitivity to spatial grid refinement, with most coarse-grid deviations reaching approximately 30\% from L1.
\end{itemize}
\end{block}
...
\begin{alertblock}{\scriptsize Aerodynamic Assessment}
\begin{itemize}
    ...
    \item L1 $C_p$ distributions are well clustered and show good agreement with experiment.
\end{itemize}
\end{alertblock}
