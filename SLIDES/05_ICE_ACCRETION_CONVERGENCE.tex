...
\begin{column}{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth]{FIGURES/ICE_SHAPES/tc_naca0012_ae3932_L1_single_layer_ice_shape_slice_0p9144_bins15_grouped_turbulence_models.png}
...
\begin{column}{0.50\textwidth}
    \centering
    \includegraphics[width=\textwidth]{FIGURES/ICE_SHAPES/tc_naca0012_ae3933_L1_single_layer_ice_shape_slice_0p9144_bins15_grouped_turbulence_models.png}
...
\begin{frame}{\small  Effect of Surface Roughness on Ice Shapes (L2, 15 Bins)}
\scriptsize
\centering
...
% ============================================================
% Ice Accretion Summary
% ============================================================

\begin{frame}{\small Ice Accretion Assessment}
\scriptsize

\begin{block}{\scriptsize Ice-Mass Prediction}
\begin{itemize}
...
\begin{itemize}
    \item Horn-angle variability reflects the code-to-code scatter observed in the ice shapes.
    \item Horn orientation is influenced by turbulence modeling and roughness height, with the geometry-extrusion method playing a major role.
...
Predictions capture the experimental reduction in horn angle from AE3932 to AE3933, but underestimate the corresponding reduction in ice mass. Final ice geometry remains strongly code-dependent.
\end{alertblock}
