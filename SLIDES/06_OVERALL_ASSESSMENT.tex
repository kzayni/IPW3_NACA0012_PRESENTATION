...
\section[Overview]{\textbf{Overall Assessment}}
...
\begin{itemize}
    ...
    \item \textbf{HTC \& Thermodynamics:} Local $HTC$ exhibits substantial code-to-code variability, influenced by turbulence modeling, roughness, and computation methodology; surface temperature and freezing fraction reflect similar code-to-code differences.
