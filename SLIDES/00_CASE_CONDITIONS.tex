...
\begin{itemize}
    ...
    Aerodynamic coefficients integrated over the full profile; icing quantities
    over the highlighted patch ($Y=32$--$40$ in); slices extracted at
    $Y=0.9144$ m ($36$ in).
...
\begin{itemize}
    ...
    \textbf{4 participants} also submitted multilayer/multishot results.
