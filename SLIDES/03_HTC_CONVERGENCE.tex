...
\begin{itemize}
    \item Surface temperature and freezing fraction exhibit substantial code-to-code variability, with no clear systematic trend whether grouped by turbulence modeling, roughness height, or thermodynamic model.
...
Integrated convective heat transfer is relatively insensitive to grid refinement, while local $HTC$ exhibits substantial code-to-code variability influenced by turbulence modeling, roughness height, and computation methodology. Surface temperature and freezing fraction show substantial variability, with no clear systematic trend regardless of the grouping considered.
\end{alertblock}
